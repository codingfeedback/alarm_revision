...
OBSERVATION_ALERT_RULE_NAME = os.getenv(
    "OBSERVATION_ALERT_RULE_NAME",
    "observation-1x-large-revision",
)
OBSERVATION_MIN_REVISION_RATIO = env_float("OBSERVATION_MIN_REVISION_RATIO", 15.0)
ALERT_COOLDOWN_HOURS = env_int("ALERT_COOLDOWN_HOURS", 6)
ALERT_COOLDOWN_MIN_MAX_REVISION_RATIO_INCREASE = env_float(
    "ALERT_COOLDOWN_MIN_MAX_REVISION_RATIO_INCREASE",
    5.0,
)
